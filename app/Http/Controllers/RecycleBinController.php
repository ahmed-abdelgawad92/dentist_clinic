  ...
  */
  public function getTeeth()
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $teeth = Tooth::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'teeth'=>$teeth
      ];
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $patients = Patient::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'patients'=>$patients
      ];
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $diagnoses = Diagnose::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'diagnoses'=>$diagnoses
      ];
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $drugs = Drug::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'drugs'=>$drugs
      ];
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $appointments = Appointment::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'visits'=>$appointments
      ];
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $working_times = WorkingTime::withoutGlobalScopes()->isDeleted()->get();
      $data=[
  ...
  {
    if(Auth::user()->role==1||Auth::user()->role==2){
      $users = User::withoutGlobalScopes()->isDeleted()->get();
      $data=[
        'users'=>$users
      ];
